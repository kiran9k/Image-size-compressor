...
public class main_image_compressor {
	...
	public main_image_compressor()
	{
		prop=config_reader.get_prop();//read config file				
	}
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Total number of files present in input directory : "+input_files.size());
